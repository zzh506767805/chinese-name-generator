...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return {
    ...
    description: 'Privacy policy for Chinese Name Generator service',
  }
}
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Our website uses Google AdSense to display advertisements. These services may collect and use information about your visits to this and other websites to provide relevant advertisements.
          </p>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>Advertising partners (Google AdSense) for ad serving purposes</li>
        ...
        <div className="bg-gray-50 p-6 rounded-lg mt-8">
          <p className="text-sm text-gray-600">
            <strong>Note:</strong> This privacy policy applies to all users of our Chinese Name Generator service. By using our service, you agree to the collection and use of information in accordance with this policy.
          </p>
        </div>
      </div>
    </div>
